...
@Component({
  ...
  imports: [NgFor, NgClass, LoaderComponent, NgIf, AddDialogComponent, ReactiveFormsModule,RouterLink],
...
export class SidebarComponent {
  ...
  @ViewChildren('details') detailsElements!: QueryList<ElementRef<HTMLDetailsElement>>;
