...
import DialogComponentForContent from "../components/ui/DialogComponentforContent";
          ...
          <div className="flex items-center gap-2">
            <nav className="hidden md:block">
              <ul role="list" className="flex items-center gap-8">
                ...
                <li >
                  <span onClick={handleAddClick} className="text-sm cursor-pointer leading-5 text-zinc-600 transition hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white">
                    Add Data
                  </span>
                </li>
                <li >
                  <span onClick={handleAddContent} className="text-sm cursor-pointer leading-5 text-zinc-600 transition hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white">
                    Add Content
                  </span>
                </li>
              </ul>
