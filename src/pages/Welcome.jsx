function Welcome() {
  return (
    ...
    <div>
      <h2 className="font-medium text-base pt-4 pb-4">Checkout my other resources</h2>
...
<div className="max-w-sm my-4 lg:my-0 bg-white border border-slate-100  rounded-xl shadow-xl  dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
        ...
        <p className="mb-3 font-normal text-gray-700 text-sm dark:text-gray-400">Get to know me: a Fullstack developer specializing in Angular, React, and Node.js, creating innovative and dynamic web solutions</p>
        <a href="https://sumanthnagireddi1.web.app/" target="_blank" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-emerald-500 rounded-lg hover:bg-emerald-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        See More
